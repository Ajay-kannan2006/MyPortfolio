        ...
        <div id='right-home'>
            <div className="home-content">
                ...
                <div class="home-buttons">
                    <a href="" className="btn-icons"><i class="fa-brands fa-github fa-xl"></i></a>
                    <a href="#projects" className="btn-icons"><i class="fa-brands fa-linkedin fa-xl"></i></a>
                    <a href="" className="btn-icons leet"><SiLeetcode /></a>
                </div>
            </div>
        </div>
    );
